...
class Minor_model extends CI_Model
{
    ...
    function get_all()
    {
      ...
      $this->db->select('ussdmenulanguage.language as language, minor_sector.minor_name, minor_sector.id,major_sector.sector_name,possible_advisories.cat,possible_advisories.advise,possible_advisories.state');
