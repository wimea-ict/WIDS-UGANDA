...
class Disaster extends CI_Controller
{
...

    {
       ...
       $datatoinsert1 = array('region_id' => $this->input->post('region_id',TRUE), 'forecast_id' => $this->uri->segment(3),
   ...
   {
    $data = array('id'=> $this->uri->segment(3), 'disaster_data'=> $this->Disaster_model->get_all($id), 'change' => 109,
        );
    $this->load->view('template',$data);  
}  
}
