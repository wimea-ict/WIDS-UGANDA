...
class Dekadal_forecast extends CI_Controller
{
    ...
    $datatoinsert = array(
        ...
        $this->session->set_flashdata('message', '<font color="green" size="5">Dekadal Forecast uploaded successfully!</font>');
            

        redirect("index.php/Dekadal_forecast");
    ...
    public function update_dekadal(){
...
//var_dump($farm);exit;
    ...
    public function delete($id) 
    {
        ...
        $this->session->set_flashdata('message', '<font color="green" size="5">Record Deleted successfully!</font>');
