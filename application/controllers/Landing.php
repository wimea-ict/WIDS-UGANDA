...
public function index() {
    ...
    public function overall_frequent_users_word()
    {
        ...
        $division_data = $this->Division_model->get_all();
        $data = array('division_data' => $division_data, 'start'=>0 );
...
function Messages($message,$phoneNumber){ 
        ...
        try{
            ...
            curl_setopt_array($ch,array(
                ...
                CURLOPT_URL =>'http://simplysms.com/getapi.php?email=mnsabagwa@cit.ac.ug&password=JAQd5E9&sender=8777&message='.$textmessage.'&recipients='.$phoneNumber,
...
public function create_user(){
    $data=array('action' => site_url('index.php/Landing/create_user_action'),'change' => 24 );
    $this->load->view('template',$data);
}
...
public function create_user_action(){
    ...
    if ($this->form_validation->run() == FALSE) {
        ...
        $mailto= mail($mailadd,"password",$msg);
            ...
            //alert user
        $this->Messages("WIDS-UGANDA: ADMIN CREDENTAILS\n Email: ".$mailadd." and Password:".$msg,$this->input->post('phone_number',TRUE));
...
public function Users(){
    $system_users = $this->Landing_model->get_all();
    $data = array(
