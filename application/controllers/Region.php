...
{ 
 ...
 $data = array('region_data' => $region, 'change' => 46 );
...
public function saveregion(){
    ...
    $datatoinsert = array('region_name' => $this->input->post('region_name',TRUE) );
    ...
    if (!is_null($id) && $this->Region_model->get_by_id($id)) {
        ...
        $datatoinsert1 = array('region_name' => $this->input->post('region_name',TRUE) );
...
public function word()
{
    ...
    $data = array('region_data' => $this->Region_model->get_all(), 'start' => 0);
