  ...
  public function index()
   ...
   public function saveForecastedTime(){
		...
		if (!is_null($id) && $this->Daily_forecast_time_model->get_by_id($id)) {
            ...
            $this->session->set_flashdata('message','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>Forecast-Time Saved Successfully!</div>');
        } else {
		  ...
		  redirect("index.php/Daily_forecast_time");
     ...
     public function delete($id=NULL){
     	 ...
     	 //if there is some data
            ...
            $this->session->set_flashdata('message','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>'.$this->session->userdata('deleted').' Period Deleted Successfully!</div>');
