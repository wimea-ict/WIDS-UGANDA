...
class Season extends CI_Controller
{
	...
	public function broadcast_msg(){
		...
		$this->session->set_flashdata('message','<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>You have Successfully Made a broadcast to'.$counter.'Contacts </div>');
	...
	function sub_regions(){
		$region_id = $this->input->post('id',TRUE);
		$data = $this->Sub_region_model->sub_regions_region($region_id);
