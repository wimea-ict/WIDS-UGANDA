...
// -----------------------------------
	...
	///	  echo $this->session->userdata('database_name')." is the database";
         ...
         //advice query
		  	//audio clip data
         		$data['clip'] = $this->Season_model->get_lang_clip($session_lang);

         		$data['seasonal_advice_home'] = $this->Season_model->get_advice($random, $session_lang);
       ...
       //==================end============================================
        ...
        //====================DEKADAL DATA================================================
			 ...
			 //===================SEASONAL DATA================================================
			 	...
			 	//advice query
         				$data['seasonal_advice'] = $this->Season_model->get_advice($division_id, $session_lang);
         				$season = $this->Season_model->get_current_season(); 
         				$data['divide'] = $season;
         				$data['seasonal_data'] = $this->Season_model->get_season_data($season, $division_id, $session_lang);
         				$data['clip'] = $this->Season_model->get_lang_clip($session_lang);
