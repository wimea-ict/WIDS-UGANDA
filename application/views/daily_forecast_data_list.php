      ...
      <div class='box'>
        <div class='box-header'>
          <h3 class='box-title'>DAILY FORECAST DATA LIST 
            ...
            echo anchor(site_url('index.php/daily_forecast/wording'), '<i class="fa fa-file-word-o"></i> Word', 'class="btn btn-primary btn-sm"'); ?>
            <?php 
            echo anchor(site_url('index.php/daily_forecast/pdf_latest'), '<i class="fa fa-file-pdf-o"></i> PDF', 'class="btn btn-primary btn-sm"'); ?> <?php 
            ...
            if(isset($identity)){
              ...
              if($cond == 1){
                  $lk = "index.php/daily_forecast/addnewforecastdata24/".$forecast_id;
              }else{
                  $lk = $link ;
              }
              echo anchor(site_url($lk), '<i class="fa fa-plus"></i> Add New', 'class="btn btn-success btn-sm"'); 
       ...
       <div class='box-body'>
        <div class="table-responsive"><table class="table table-bordered table-striped" id="mytable">
           ...
           // echo anchor(site_url('index.php/daily_forecast/areaforecast_list/'.$p->id),'<i class="fa fa-cloud"></i>',array('title'=>'Area forecast','class'=>'btn btn-primary btn-sm')); 
              ...
              echo '  ';
              echo anchor(site_url('index.php/daily_forecast/delete/'.$p->id),'<i class="fa fa-trash-o"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javasciprt: return confirm(\'Are you sure, you want to delete this record ?\')"');
