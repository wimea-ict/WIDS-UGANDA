            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
                  ...
                  <h3 class='box-title'>DAILY FORECAST GENERAL INFORMATION</h3>
 ...
 <?php if(!isset($daily_forecasted)){ ?>
        ...
        <tr>
          <td>Forecasted Date:</td>
            <td><input type="date" value="<?=$fdate  ?>" class="form-control" name="date_forecasted" id="date_forecasted" required /></td>        
        </tr> 
       ...
       <tr>
        <td>Weather Summary <?php echo form_error('weather') ?></td>
            <td><textarea class="form-control" rows="3" name="weather" id="weather" required placeholder="Weather summary"><?php echo $summary;  ?></textarea>
      ...
      <tr><td colspan='2'>
        ...
        <a class="btn btn-default" href="<?php echo base_url("index.php/Daily_forecast/index");?>">Cancel</a>
    </td></tr>
