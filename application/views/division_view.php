            ...
            <div class='col-xs-12'>
              <div class='box'>
                <div class='box-header'>
                  <h3 class='box-title'>LIST OF DISTRICTS <?php
       ...
       <?php echo anchor(site_url('index.php/division/word'), '<i class="fa fa-file-word-o"></i> Word', 'class="btn btn-primary btn-sm"'); ?>
        ...
        <?php echo anchor(site_url('index.php/Division/displayform'), '<i class="fa fa-plus"></i> Add New', 'class="btn btn-success btn-sm"'); ?>
