      ...
      <?php echo anchor(site_url('index.php/Dekadal_forecast/create'), '<i class="fa fa-plus"></i> Add New Forecast', 'class="btn btn-primary btn-sm"'); ?>
  </h3>        
	    ...
	    <tbody>
			...
			//echo '  '; 
			     ...
			     echo '  '; 
			     echo anchor(site_url('index.php/dekadal_forecast/delete/'.$d->id),'<i class="fa fa-trash-o"></i>','title="delete" class="btn btn-danger btn-sm" onclick="javascript: return confirm(\'Are you sure, you want to delete this record ?\')"'); 
    echo '  ';
