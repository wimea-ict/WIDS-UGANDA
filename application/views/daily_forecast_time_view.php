	...
	<?php echo anchor(site_url('index.php/daily_forecast/timeword'), '<i class="fa fa-file-word-o"></i> Export Word', 'class="btn btn-primary btn-sm"'); ?><?php echo " ".anchor(site_url('index.php/daily_forecast/timepdf'), '<i class="fa fa-file-pdf-o"></i> Export PDF', 'class="btn btn-primary btn-sm"'); ?></h3>
        <?php echo anchor(site_url('index.php/Daily_forecast_time/DailyForecastTimeForm'), '<i class="fa fa-plus"></i> Add Period', 'class="btn btn-success btn-sm"'); ?>
