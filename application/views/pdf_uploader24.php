...
<section class="content-header">
                    <h1>
                        Daily
                        <small>24 hourly Forecast form</small>
                    </h1>
                    <ol class="breadcrumb">
            ...
            <div class='col-xs-8 col-md-8'>
              <div class='box'>
                <div class='box-header'>
                  ...
                  <h3 class='box-title'>24 HOURLY DAILY FORECAST UPLOADER &nbsp;&nbsp; <i style="color: red"> Remaining Units:</i> <?=$remaining_units?></h3>
                      <div class='box box-primary'>
        <form action="<?php echo  site_url('index.php/CSV_file/CSV_file24')?>" method="post" enctype="multipart/form-data">
          
 <!-- get the regions for the dailyforecast_region table-->
      <table class="table table-bordered">
        <tr>
          <td>Upload 24-HOURLY Forecast </td>
        </tr> 
        ...
        <tr>
          ...
          <td><select  id="target" name="file_type" required="" class="form-control">
        ...
        <tr>
          ...
          <td>
            ...
            <div id="excel" class="inv">
              <input type="file" name="file22" accept=".xlsx" /><span style="color: red">Only .xlsx format</span>
            </div>
            </td>
        </tr>
       <tr>
