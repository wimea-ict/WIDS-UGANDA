 ...
 <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                      <?php $this->session->set_flashdata('message', ''); ?>
                        ...
                        <li><a href="<?php echo base_url() ?>index.php/Dekadal_forecast/index"><i class="fa fa-dashboard"></i> Dekadal Forecast</a></li>
...
<section class="content" id="dashboard-content">
       ...
       <?php
            $btn_text ="Submit";
            $regionid = '';
            $action = site_url('index.php/Dekadal_forecast/saveForecast');
        //    $sub_region = '';
             //print_r($dekadal_data);exit();
             if(isset($dekadal_data)){
               $btn_text ="Update";
               $action = site_url('index.php/Dekadal_forecast/update_dekadal');
               $count =0;
       ...
       <a class="btn btn-default" href="<?php echo base_url("index.php/Dekadal_forecast/index");?>">Cancel</a>
	    </td></tr>
