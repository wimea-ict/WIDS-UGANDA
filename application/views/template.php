             ...
             <a href="#" class="dropdown-toggle" data-toggle="dropdown"> 
              ...
              <ul class="dropdown-menu">
                ...
                if($ct < 1){ ?>
                  ...
                  if($there_is == false){?>
                    <li><a href="<?php echo base_url('Daily_forecast') ?>" style="color: red">6 Hourly Daily Forecast Data Unavailable</a></li> 
                    <?php 
                  }else{
                   if(isset($daily_missing) && sizeof($daily_missing) > 0){ ?>
                    <li><a href="<?php echo base_url('daily_forecast/daily_forecast_data')."/".$daily_forecast_id ?>" style="color: red">Daily Forecast Missing Region Data</a></li> 
                    <?php 
                    foreach ($daily_missing as $k) { ?>
                      <li><a href="<?php echo base_url('daily_forecast/addnewforecastdata').'/'.$daily_forecast_id  ?>"><?php echo $k; ?></a></li> 
                    <?php }
                  }
                }
                ...
                if($exist == false){ ?>
                  ...
                  if(isset($missing) && sizeof($missing) > 0){ ?>
                    <li><a href="<?php echo base_url('Season/showareaforecast').'/'.$forecast_id  ?>" style="color: red">Seasonal Forecast Missing Region Data</a></li> 
                    <?php 
                    foreach ($missing as $k) { ?>
                      <li><a href="<?php echo base_url('Season/createregionforecast').'/'.$forecast_id  ?>"><?php echo $k; ?></a></li> 
                    <?php }
                  }
                }
              }
          ...
          <!-- User Account: style can be found in dropdown.less -->       <li class="dropdown user user-menu"> 
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <center><div>
                  <?php
                  echo anchor('logout','Log out',array('class'=>'btn btn-default btn-flat'));
                  ?>
    ...
    <section class="sidebar" >
      ...
      <div>
                  ...
                  <!-- <p><?php 
                               ...
                               <a href="<?php// echo base_url(); ?>Auth/change_pass"><button type="button" class="btn">Change password</button></a><?php
                           ...
                           <ul class="sidebar-menu">
                            ...
                            <?php   echo "<li>" . anchor('dashboard', "<i class='fa fa-laptop'></i> <span>" . strtoupper('Dashboard')) . "</span></li>"; ?>
                ...
                //monthly forecast
                  ...
                  $this->load->view('web_visits');
                }else if($change == 135){
                  $this->load->view('session_tracker');
                }else if($change == 136){
                  $this->load->view('subscription_messages');
                }else if($change == 137){
