...
<section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url() ?>index.php/Daily_forecast"><i class="fa fa-dashboard"></i> Daily Forecast</a></li>
 ...
 <?php
         ...
         for($m=0;$m<sizeof($temp);$m++){
                ...
                echo "<td>".($m+1)."</td>";
                echo "<td>".$regs[$m]."</td>";
                echo "<td>".$weather_desc1[$m]."</td>";
                echo "<td>".$temp1[$m]."</td>";
                echo "<td>".$wind_dir1[$m]."</td>";
                echo "<td>".$wind_str1[$m]."</td>";
                echo "</tr>";
            }
            echo "</table>"; ?>
    </table>
 ...
 <?php
         ...
         for($m=0;$m<sizeof($temp);$m++){
                ...
                echo "<td>".($m+1)."</td>";
                echo "<td>".$regs[$m]."</td>";
                echo "<td>".$weather_desc2[$m]."</td>";
                echo "<td>".$temp2[$m]."</td>";
                echo "<td>".$wind_dir2[$m]."</td>";
                echo "<td>".$wind_str2[$m]."</td>";
                echo "</tr>";
            }
            echo "</table>"; ?>
    </table>
 ...
 <?php
         ...
         for($m=0;$m<sizeof($temp);$m++){
                ...
                echo "<td>".($m+1)."</td>";
                echo "<td>".$regs[$m]."</td>";
                echo "<td>".$weather_desc3[$m]."</td>";
                echo "<td>".$temp3[$m]."</td>";
                echo "<td>".$wind_dir3[$m]."</td>";
                echo "<td>".$wind_str3[$m]."</td>";
                echo "</tr>";
            }
            echo "</table>"; ?>
    </table>
