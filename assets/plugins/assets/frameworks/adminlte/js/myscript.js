        ...
        function box(){
          ...
          // window.alert(x); 
          window.open("/wids/index.php/map/agric/"+x,"_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=400,height=400");
       ...
       function roadbox(){
          var x = infowindowContent.children['place-name'].textContent;
          // window.alert(x); 
          window.open("/wids/index.php/map/road/"+x,"_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=400,height=400");
       ...
       function foodbox(){
          var x = infowindowContent.children['place-name'].textContent;
          // window.alert(x); 
          window.open("/wids/index.php/map/food/"+x,"_blank", "toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=400,height=400");
